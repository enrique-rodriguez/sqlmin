...
class SqlMinifierTestCase(unittest.TestCase):
    ...
    def test_minified_integration_1_gives_same_result(self):
        ...
        assert self.minifier.minify(self.minifier.minify(sql)) == self.minifier.minify(sql)
